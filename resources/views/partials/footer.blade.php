<footer class="bg-gradient-to-br from-[#0B0F19] to-[#1A2338] text-white pt-24 pb-10 border-t border-white/5 relative overflow-hidden" id="contact">
    ...
    <a class="fixed bottom-6 right-6 bg-green-600 hover:bg-green-700 text-white py-3 px-6 rounded-full shadow-lg inline-flex items-center gap-2 z-50 transition-colors" href="#">
        <span class="inline-flex h-5 w-5 items-center justify-center">
            <svg aria-hidden="true" viewBox="0 0 24 24" class="h-5 w-5 fill-current">
                <path d="M12.04 2.01c-5.51 0-9.99 4.49-9.99 10.01 0 1.77.46 3.49 1.33 5.01L2 22l5.06-1.33c1.47.8 3.12 1.22 4.98 1.22 5.52 0 10-4.49 10-10.01 0-5.52-4.48-10.01-10-10.01zm0 18.15c-1.66 0-3.2-.5-4.5-1.35l-.33-.2-3 .79.8-2.92-.21-.31c-.92-1.35-1.41-2.94-1.41-4.64 0-4.6 3.74-8.35 8.35-8.35 4.6 0 8.35 3.75 8.35 8.35 0 4.6-3.75 8.35-8.35 8.35zm4.63-6.28c-.25-.12-1.46-.72-1.69-.8-.23-.08-.4-.12-.57.12-.17.25-.65.8-.8.97-.15.17-.29.19-.54.06-.25-.12-1.05-.39-2-1.25-.74-.66-1.24-1.47-1.38-1.72-.14-.25-.01-.38.11-.51.11-.11.25-.29.37-.43.12-.14.17-.25.25-.41.08-.17.04-.31-.02-.43-.06-.12-.57-1.36-.78-1.87-.2-.48-.41-.42-.57-.43h-.49c-.17 0-.43.06-.66.31-.23.25-.87.85-.87 2.08 0 1.22.9 2.4 1.02 2.57.12.17 1.76 2.69 4.26 3.77.6.26 1.07.41 1.44.53.6.19 1.15.16 1.58.1.48-.07 1.46-.6 1.67-1.18.2-.58.2-1.07.14-1.18-.06-.11-.22-.17-.47-.29z"/>
            </svg>
        </span>
        <span class="font-bold text-sm whitespace-nowrap">Ada yang dapat saya bantu?</span>
    </a>
</footer>
